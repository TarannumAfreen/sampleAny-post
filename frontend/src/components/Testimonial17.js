                  ...
                  {props.review1 ?? (
                    <Fragment>
                      <span className="testimonial17-text34 thq-body-small">
                        Any-Post has made it incredibly easy for us to find the
                        services we need. Highly recommended!
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.review2 ?? (
                    <Fragment>
                      <span className="testimonial17-text28 thq-body-small">
                        I&apos;ve sold multiple items on Any-Post within days of
                        posting. Great platform for buying and selling.
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.review3 ?? (
                    <Fragment>
                      <span className="testimonial17-text36 thq-body-small">
                        I love how I can easily search for gigs in my area.
                        Any-Post has helped me find new clients consistently.
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.review4 ?? (
                    <Fragment>
                      <span className="testimonial17-text37 thq-body-small">
                        The ability to save listings and message sellers
                        directly has saved me so much time. Thank you, Any-Post!
                      </span>
                    </Fragment>
                  )}
                </span>
...
Testimonial17.defaultProps = {
  ...
  author1Alt: "John Doe - CEO of Example Company",
  author2Src:
  ...
  author2Alt: "Jane Smith - Founder of ABC Startup",
  author4Alt: "Sarah Lee - Small Business Owner",
  content1: undefined,
